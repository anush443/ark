...
const Footer = (props) => {
  return (
    <footer>
      <div
        className={`max-w-6xl mx-auto text-center px-6 py-6  text-[#989898] ${props.custom}`}
      >
        <div className="flex flex-col items-center justify-center space-y-8   md:flex-row md:space-y-0 ">
          <div className="flex justify-between w-32 py-1">
            <span className="cursor-pointer" onClick={() => openInNewTab(`https://www.facebook.com/profile.php?id=100067774263936&mibextid=LQQJ4d`)}>
            ...
            <span className="cursor-pointer" onClick={() => openInNewTab(`https://instagram.com/ark.designers?igshid=MzRlODBiNWFlZA==`)} >
